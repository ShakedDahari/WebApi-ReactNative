...
export default function BusinessRegistration(props) {
    ...
    let { foodTypes, LoadFoodTypes, emailB, setEmailB, phoneB, setPhoneB, nameB, setNameB, city, setCity, foodTypeB, setFoodTypeB, imgB, setImgB, 
        passwordB, setPasswordB, confirmB, setConfirmB, checkEmailBusiness, addRestaurant } = useContext(ContextPage);
    ...
    const handleSend = async () => {
        ...
        if (emailB && phoneB && nameB && city && phoneB && foodTypeB && imgB && passwordB && confirmB) {
            if (isEmailOccupied) {
        ...
        isEmailOccupied = await checkEmailBusiness(emailB);
    };
