...
export default function Login(props) {
  ...
  const { email, password, setEmail, setPassword, setLoginUser, checkLoginUser, checkLoginRestaurant } = useContext(ContextPage);
    ...
    try {
      if (!isRestaurantOwner) {
        ...
        if (user) {
          ...
          if (email.toLowerCase() === "shaked1299@gmail.com") {
        ...
        const restaurant = await checkLoginRestaurant(email, password);
        if (restaurant) {
