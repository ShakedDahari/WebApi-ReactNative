...
export default function Home(props) {
  ...
  const { location, setLocation, errorMsg, setErrorMsg, foodType, setFoodType, foodListVisible, setFoodListVisible, foodTypes, findRestaurants, setIsLoading } = useContext(ContextPage);
  ...
  const handleFind = () => {
    ...
    if (location && foodType) {
        findRestaurants(location, foodType);
        setIsLoading(true);
